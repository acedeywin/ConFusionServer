...
usersRouter
  ...
  .post("/signup", corsDefault.corsWithOptions, (req, res, next) => {
    User.register(
  ...
  .post("/login", corsDefault.corsWithOptions, (req, res, next) => {
  ...
  .get("/checkJWTToken", corsDefault.corsWithOptions, (req, res) => {
